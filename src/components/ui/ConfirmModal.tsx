...
export default function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="bg-background border border-border w-full max-w-sm rounded-2xl shadow-xl overflow-hidden animate-scale-up">
        <div className="p-6">
        ...
        <div className="px-6 py-4 bg-background-elevated border-t border-border flex justify-end gap-3">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isLoading}
            className={`px-4 py-2 text-sm font-medium rounded-xl transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed ${getVariantStyles()}`}
          >
