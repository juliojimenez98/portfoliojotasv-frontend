...
export const metadata: Metadata = {
  title: "Julio Jiménez — Portafolio & Sobre Mí",
  description: "Portafolio personal, trayectoria, habilidades y proyectos de Julio Jiménez — Desarrollador Full-Stack.",
};
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 glass-strong">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link href="/me" className="text-lg font-bold gradient-text">
              JJ
            </Link>
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <Link
                href="/app"
                className="text-sm px-4 py-2 rounded-xl bg-gradient-to-r from-primary to-secondary text-white font-bold hover:shadow-[0_0_20px_rgba(139,92,246,0.3)] transition-all flex items-center gap-1.5"
              >
                <span>🚀</span>
                <span>JotasVApp</span>
              </Link>
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen px-4 pt-16 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-3xl animate-fade-in">
          ...
          <p className="text-lg sm:text-xl text-foreground-muted max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            <span className="text-primary-light font-semibold">Next.js</span> y{' '}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/app"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl border border-primary/30 bg-primary/5 text-primary-light hover:bg-primary/10 transition-all font-semibold"
            >
              Entrar a JotasVApp 🚀
            </Link>
          </div>
      ...
      <section id="projects" className="relative py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-foreground-muted max-w-2xl mx-auto">
              Aplicaciones y herramientas construidas dentro de JotasVApp.
            </p>
          </div>
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <Link href="/app" className="text-primary hover:underline text-sm font-semibold">
              JotasVApp 🚀
            </Link>
            <a href="https://github.com/juliojimenez98" target="_blank" rel="noopener noreferrer" className="text-foreground-subtle hover:text-foreground transition-colors text-sm">
              GitHub
            </a>
          </div>
        </div>
