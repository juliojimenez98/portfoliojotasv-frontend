          ...
          <Card key={user._id} variant="glow" hover>
            <CardHeader>
              <div className="flex justify-between items-start w-full">
                ...
                {user.isAdmin && <Badge variant="danger" dot>Admin</Badge>}
              </div>
            </CardHeader>
            <div className="p-4 md:p-6 pt-0">
              <div className="mt-4">
                <p className="text-xs text-foreground-subtle uppercase mb-2">Acceso a Apps</p>
                <div className="flex flex-wrap gap-2">
                  {user.allowedApps?.length > 0 ? (
                    ...
                    <span className="text-sm text-foreground-muted">Sin accesos</span>
                  )}
                </div>
              </div>
              ...
              <div className="mt-6 pt-4 border-t border-white/5">
                <Link 
                  ...
                  className="block w-full py-2 text-center text-sm font-medium text-white bg-white/5 hover:bg-white/10 rounded-lg transition-colors"
                >
                  Editar Permisos
                </Link>
              </div>
